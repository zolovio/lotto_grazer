...
import 'package:lotto_grazer/features/saved_plans/forecast_details/sequential_number/sequential_number_forecast_details_vm.dart';
...
class SequentialNumberForecastDetails extends StatefulWidget {
  ...
  const SequentialNumberForecastDetails({
    super.key,
  ...
  @override
  State<SequentialNumberForecastDetails> createState() =>
      _SequentialNumberForecastDetailsState();
}

class _SequentialNumberForecastDetailsState
    extends State<SequentialNumberForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(sequentialNumberForecastDetailsProvider);
            ...
            Row(
              ...
              children: [
                ...
                CustomContainer(
                  ...
                  title: 'In any given event the five(5) winning numbers '
                      'must be arrange in a numeric order ${widget.num1}, with a constant number ${widget.num2} '
