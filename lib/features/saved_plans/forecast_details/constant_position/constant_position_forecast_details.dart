...
import 'package:lotto_grazer/features/saved_plans/forecast_details/constant_position/constant_position_forecast_details_vm.dart';
...
class ConstantPositionForecastDetails extends StatefulWidget {
  ...
  final String num1;
  const ConstantPositionForecastDetails({
    super.key,
  ...
  @override
  State<ConstantPositionForecastDetails> createState() =>
      _ConstantPositionForecastDetailsState();
}

class _ConstantPositionForecastDetailsState
    extends State<ConstantPositionForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(constantPositionForecastDetailsProvider);
            ...
            Row(
              ...
              children: [
                ...
                CustomContainer(
                  ...
                  title: 'In any given event, a constant number ${widget.num1} '
                      'must be in the 2nd box winning number.',
                  bgColor: AppColors.whiteColor.withOpacity(0.1),
                  fgColor: AppColors.blackColor,
                  fontsize: 14.5,
