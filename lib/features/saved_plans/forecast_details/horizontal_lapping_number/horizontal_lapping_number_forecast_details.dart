...
import 'package:lotto_grazer/features/saved_plans/forecast_details/horizontal_lapping_number/horizontal_lapping_number_forecast_details_vm.dart';
...
class HorizontalLappingNumberForecastDetails extends StatefulWidget {
  ...
  final String num1;
  final String num2;
  const HorizontalLappingNumberForecastDetails({
    super.key,
  ...
  @override
  State<HorizontalLappingNumberForecastDetails> createState() =>
      _HorizontalLappingNumberForecastDetailsState();
}

class _HorizontalLappingNumberForecastDetailsState
    extends State<HorizontalLappingNumberForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(horizontalLappingNumberForecastDetailsProvider);
            ...
            Row(
              ...
              children: [
                ...
                CustomContainer(
                  ...
                  title:
                      'In any two given event the number ${widget.num1} Laps ${widget.num2} on the 2nd and 3rd box winning horizontally.',
                  bgColor: AppColors.whiteColor.withOpacity(0.1),
                  fgColor: AppColors.blackColor,
                  fontsize: 15.0,
