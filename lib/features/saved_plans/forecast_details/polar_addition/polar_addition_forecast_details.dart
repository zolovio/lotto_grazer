...
import 'package:lotto_grazer/features/saved_plans/forecast_details/polar_addition/polar_addition_forecast_details_vm.dart';
...
class PolarAdditionForecastDetails extends StatefulWidget {
  ...
  const PolarAdditionForecastDetails({
    super.key,
  ...
  @override
  State<PolarAdditionForecastDetails> createState() =>
      _PolarAdditionForecastDetailsState();
}

class _PolarAdditionForecastDetailsState
    extends State<PolarAdditionForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(polarAdditionForecastDetailsProvider);
            ...
            Row(
              ...
              children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          NumberCardWithTitle(
                              num: widget.num1, title: "ADDITION"),
                          SizedBox(
                            width: 5.h,
                          ),
                          NumberCardWithTitle(
                ...
                CustomContainer(
                  ...
                  title:
                      'In any given event the sum of the 1st and 5th box winning numbers '
