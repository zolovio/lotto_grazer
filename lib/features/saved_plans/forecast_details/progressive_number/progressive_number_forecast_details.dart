...
import 'package:lotto_grazer/features/saved_plans/forecast_details/progressive_number/progressive_number_forecast_details_vm.dart';
...
class ProgressiveNumberForecastDetails extends StatefulWidget {
  final String lotteryGameName;
  final String date;
  final String planType;
  final String planName;
  final String winningNum1;
  final String signCode1;
  final String signCode2;

  const ProgressiveNumberForecastDetails(
      {super.key,
      ...
      required this.signCode1,
      required this.signCode2});

  @override
  State<ProgressiveNumberForecastDetails> createState() =>
      _ProgressiveNumberForecastDetailsState();
}

class _ProgressiveNumberForecastDetailsState
    extends State<ProgressiveNumberForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(progressiveNumberForecastDetailsProvider);
      ...
      return Scaffold(
        ...
        body: ListView(
          children: [
            ...
            DateAndWeekRow(
                gameName: "NL FORTUNE", countingWeek: "1", date: widget.date),
            Row(
              children: [
                CustomContainer(
              ...
              children: [
                CustomChildContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (widget.planName == 'PROGRESSIVE NUMBER') ...[
                        WCard(
                          label: widget.winningNum1,
                          borderColor: Colors.transparent,
                        ),
                        if (widget.planType == 'VERTICAL') ...[
                          CustomChildContainer(
                ...
                CustomContainer(
                  ...
                  title: (widget.planType != 'HORIZONTAL')
                      ? 'In any two given event the five(5) winning numbers '
                          'progressive sign code of the 1st event must be -- + -- ++ '
                          'and that of the 2nd event must be ++ -- ++ .'
                      : 'In any two given event the five(5) winning numbers '
                          'progressive sign code of the 1st event must be + -- -- + '
                          'and that of the 2nd event must be + -- ++ .',
                  bgColor: AppColors.whiteColor.withOpacity(0.1),
