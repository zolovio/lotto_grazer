...
import 'package:lotto_grazer/features/saved_plans/forecast_details/ball_spacing/ball_spacing_forecast_details_vm.dart';
...
class BallSpacingForecastDetails extends StatefulWidget {
  ...
  const BallSpacingForecastDetails({
    super.key,
  ...
  @override
  State<BallSpacingForecastDetails> createState() =>
      _BallSpacingForecastDetailsState();
}

class _BallSpacingForecastDetailsState
    extends State<BallSpacingForecastDetails> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final _vm = ref.watch(ballSpacingForecastDetailsProvider);
              ...
              children: [
                CustomChildContainer(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (widget.planName == 'BALL SPACING') ...[
                        ...
                        NumberCardWithTitle(num: widget.num1, title: "SPACING")
                      ],
                    ],
                  ),
                ),
                CustomContainer(
                  ...
                  title: (widget.planType != 'HORIZONTAL')
                      ? 'In any two given event the number difference '
                          'between the 1st box winning number on the first event and 1st box winning numbers '
                          'on the 2nd event must be equal to${widget.num1}'
                      : 'In any given event the number difference between the 1st and 2nd '
                          'box winning numbers must be equal to ${widget.num1}',
                  bgColor: AppColors.whiteColor.withOpacity(0.1),
                  fgColor: AppColors.blackColor,
                  fontsize: 14.sp,
