...
import 'package:lotto_grazer/features/grenco_numbers/grenco_forecast_details/reference_events/reference_events_vm.dart';
...
class ReferenceEventsScreen extends StatefulWidget {
  const ReferenceEventsScreen({super.key});

  @override
  State<ReferenceEventsScreen> createState() => _ReferenceEventsScreenState();
}

class _ReferenceEventsScreenState extends State<ReferenceEventsScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final vm = ref.watch(referenceEventsVmProvider);
      return SafeArea(
        child: Scaffold(
