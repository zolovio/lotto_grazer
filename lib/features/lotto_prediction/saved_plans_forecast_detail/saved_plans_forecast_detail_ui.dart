...
import 'package:lotto_grazer/features/lotto_prediction/saved_plans_forecast_detail/saved_plans_forecast_detail_vm.dart';
...
class SavedPlansForecastDetail extends StatefulWidget {
  final SavedPlansData plansData;
  final String countingWeek;
  const SavedPlansForecastDetail(
      {super.key, required this.plansData, required this.countingWeek});

  @override
  State<SavedPlansForecastDetail> createState() =>
      _SavedPlansForecastDetailState();
}

class _SavedPlansForecastDetailState extends State<SavedPlansForecastDetail> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: Consumer(builder: (context, ref, _) {
          final vm = ref.watch(savedPlansForecastDetailProvider);
          return ListView(
            children: [
              CustomContainer(
