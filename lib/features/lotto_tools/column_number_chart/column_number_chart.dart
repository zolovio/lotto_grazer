...
import 'package:lotto_grazer/features/lotto_tools/column_number_chart/column_number_chart_vm.dart';
import 'package:lotto_grazer/res/components/custom_child_container.dart';
import 'package:lotto_grazer/res/components/custom_container.dart';
import 'package:lotto_grazer/res/colors.dart';

class ColumnNumberChartScreen extends StatefulWidget {
  const ColumnNumberChartScreen({super.key});

  @override
  State<ColumnNumberChartScreen> createState() =>
      _ColumnNumberChartScreenState();
}

class _ColumnNumberChartScreenState extends State<ColumnNumberChartScreen> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final vm = ref.watch(columnNumberChartVmProvider);
      return Expanded(
        child: ListView(
          children: [
