...
import 'package:lotto_grazer/features/lotto_tools/ending_number_chart/ending_number_chart_vm.dart';
import 'package:lotto_grazer/res/components/custom_child_container.dart';
import 'package:lotto_grazer/res/components/custom_container.dart';
import 'package:lotto_grazer/res/colors.dart';

class EndingNumberChartScreen extends StatefulWidget {
  const EndingNumberChartScreen({super.key});

  @override
  State<EndingNumberChartScreen> createState() =>
      _EndingNumberChartScreenState();
}

class _EndingNumberChartScreenState extends State<EndingNumberChartScreen> {
  @override
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final vm = ref.watch(endingNumberChartVmProvider);
      return Expanded(
        child: ListView(
          children: [
