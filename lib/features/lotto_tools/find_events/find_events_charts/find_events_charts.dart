...
import 'package:lotto_grazer/features/lotto_tools/find_events/find_events_charts/find_events_charts_vm.dart';
...
class FindEventsChartsScreen extends StatefulWidget {
  const FindEventsChartsScreen({super.key});

  @override
  State<FindEventsChartsScreen> createState() => _FindEventsChartsScreenState();
}

class _FindEventsChartsScreenState extends State<FindEventsChartsScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, _) {
      final vm = ref.watch(findEventsChartsVmProvider);
      return SafeArea(
        child: Scaffold(
